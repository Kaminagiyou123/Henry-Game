...
Anne resisted the king's attempts to seduce her and refused to become his mistress as her sister Mary Boleyn had been. It soon became the one absorbing object of the King's desires to secure a divorce from his wife Catherine of Aragon so that he could marry Anne. He wrote a love letter that provides evidence of some level of intimacy between them, in which he admires her "pretty duckies" (breasts).[11] It eventually became clear that Pope Clement VII was unlikely to give the king an annulment, so Henry began to break the power of the Catholic Church in England.

Henry dismissed Thomas Wolsey from public office and later had the Boleyn family's chaplain Thomas Cranmer appointed Archbishop of Canterbury. In 1533, Henry and Anne went through a secret wedding service.[12] She soon became pregnant and there was a second, public wedding service in London on 25 January 1533. On 23 May 1533, Cranmer declared the marriage of Henry and Catherine null and void. Five days later, Cranmer declared the marriage of Henry and Anne to be good and valid. Soon after, the Pope launched sentences of ex-communication against the King and the Archbishop. As a result of Anne's marriage to the King, the Church of England was forced to break with Rome and was brought under the king's control.[12] Anne was crowned Queen Consort of England on 1 June 1533, and she gave birth to Henry's second daughter Elizabeth on 7 September. She failed to produce a male heir, her only son being stillborn. Henry grew tired of her and had their marriage annulled. Thomas Cromwell devised a plot to execute her.
...
`,
  },
  {
    ...
    name: "Jane Seymour",
    number: 3,
    text: `Jane Seymour (c. 1508 – 24 October 1537) was Henry's third wife. She served Catherine of Aragon as maid-of-honour and was one of Anne Boleyn's ladies-in-waiting.[13]

Jane, the daughter of Sir John Seymour, a knight, and Margery Wentworth, was most likely born at Wulfhall, Wiltshire,[14] although West Bower Manor in Somerset has also been suggested.,[15] her birth date is not recorded. She was of lower birth than most of Henry's wives, only being able to read and write a little, but was much better at needlework and household management, which were considered much more necessary.

Jane married Henry VIII on 20 May 1536, at the Palace of Whitehall, Whitehall, London, the day after Anne Boleyn's execution. Almost a year and a half after marriage Jane gave birth to a male heir, Edward, but she died twelve days later from postpartum complications. Henry suffered genuine grief, as she was the only one of his wives to receive a queen's burial. When he died, he was buried next to her in St George's Chapel, Windsor Castle.`,
  },
  {
    img: "https://upload.wikimedia.org/wikipedia/commons/5/54/AnneCleves.jpg",
    name: "Anne of Cleves",
    number: 4,
    text: `Anne of Cleves (22 September 1515 – 16 July 1557) was a German princess,[16] Henry's wife and queen consort of England, although not crowned, for just six months in 1540, from 6 January to 9 July. Henry may have referred to her as "A Flanders mare", and the label has stuck.[17]

Her pre-contract of marriage with Francis I, Duke of Lorraine, was cited as grounds for annulment, even though their marriage did not proceed. Anne did not resist the annulment, claiming the marriage had not been consummated and was rewarded with a generous settlement including Hever Castle, the former home of the Boleyns, Henry's former in-laws. She was given the name "The King's Sister", and was a lifelong friend to him and his children. She outlived the King and all his wives, dying at Chelsea Old Manor on 16 July 1557; the most likely cause of her death was cancer.[18] She was buried in Westminster Abbey on 3 August.[19]`,
  },
  {
    img:
